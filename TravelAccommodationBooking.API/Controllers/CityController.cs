...
namespace TravelAccommodationBooking.API.Controllers
{
    ...
    public class CityController : ControllerBase
    {
        ...
        private readonly IValidator<CityAdminRequest> _cityValidator;
        ...
        [SwaggerResponse(StatusCodes.Status201Created, "Successfully created city.", typeof(CityAdminResponse))]
        ...
        public async Task<ActionResult<CityAdminResponse>> CreateCity(CityAdminRequest cityDto)
        {
            ...
            try
            {
                ...
                var createdCityDto = _mapper.Map<CityAdminResponse>(newCity);
        ...
        //    try
        //    {
        //        var trendingCities = await _cityService.GetTopBookedCitiesAsync();
        ...
        /*
        [HttpGet("TopBooked")]
        public async Task<IActionResult> GetTopBookedCities()
        {
            try
            {
                var topCities = await _cityService.GetTopBookedCitiesAsync();
                if (topCities == null || !topCities.Any())
                {
                    return NotFound("No top booked cities found");
                }
